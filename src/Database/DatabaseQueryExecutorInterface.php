...
interface DatabaseQueryExecutorInterface
{
     ...
     *
     * Equivalent to calling {@see execute()} followed by {@see lastInsertId()}.
     * Use this when you need the generated primary key immediately after insertion.
     *
     * > **PostgreSQL**: `lastInsertId()` returns 0 on PostgreSQL without a sequence name.
     * > Append `RETURNING id` to your INSERT and call {@see fetchOne()} instead.
     *
     * @param SqlParameters $parameters
     */
