...
| `…/invalid-json` | 400 | Invalid JSON | Corps de requête vide, JSON invalide ou non-objet JSON |
...
| `…/too-many-requests` | 429 | Too Many Requests | Limite de taux dépassée (`ThrottleMiddleware`) ; en-tête `Retry-After` inclus |
