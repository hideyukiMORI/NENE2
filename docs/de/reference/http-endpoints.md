...
|---|---|---|---|
| `GET` | `/health` | Keine | `200` `{ service, status[, checks] }` oder `503` bei Degradierung |
| `GET` | `/examples/ping` | Keine | `200` `{ message }` |
| `GET` | `/` | Keine | `200` `{ name, description, status }` JSON-Antwort |

## Notes (Notizen)

| Methode | Pfad | Auth | Erfolg | Fehler |
|---|---|---|---|---|
| `GET` | `/examples/notes` | Keine | `200` Liste | `422` |
| `POST` | `/examples/notes` | Keine | `201` Notiz | `400`, `413`, `422` |
| `GET` | `/examples/notes/{id}` | Keine | `200` Notiz | `404`, `413` |
| `PUT` | `/examples/notes/{id}` | Keine | `200` Notiz | `400`, `404`, `413`, `422` |
...
| Methode | Pfad | Auth | Erfolg | Fehler |
|---|---|---|---|---|
| `GET` | `/examples/tags` | Keine | `200` Liste | `422` |
| `POST` | `/examples/tags` | Keine | `201` Tag | `400`, `413`, `422` |
| `GET` | `/examples/tags/{id}` | Keine | `200` Tag | `404` |
| `PUT` | `/examples/tags/{id}` | Keine | `200` Tag | `400`, `404`, `422` |
