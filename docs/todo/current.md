...
- Latest release: `v1.5.123`（2026-05-26 リリース済み、PR #922 pending CI）
...
| ~~FT178〜187~~ | ~~JSON Merge Patch〜Encrypted Field Storage 等~~ | ~~完了 v1.5.112〜122（PR pending CI）~~ |
| ~~FT188~~ | ~~Numeric Verification Code（verifylog）~~ | ~~完了 v1.5.123（PR #922 pending CI）ATK-01〜12 全 Pass~~ |
| 📋 FT189 | 次テーマ | 脆弱性診断（周期: VULN-A〜L） |
